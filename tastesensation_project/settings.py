"""
Django settings for tastesensation_project project.
...
# Explicitly tells Django the site number and redirects user
# to home page once they have logged in or out.
SITE_ID = 1
LOGIN_REDIRECT_URL = '/'
LOGOUT_REDIRECT_URL = '/'
...
ROOT_URLCONF = 'tastesensation_project.urls'
